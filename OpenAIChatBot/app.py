...
#temperature is [0,1] gives the randomness of the response, i.e. the more the value the more random(creative) the response will be
def generate_response(question,api_key,engine,temprature,max_tokens):
    openai.api_key=api_key
    llm=ChatOpenAI(model=engine,temperature=temprature,max_tokens=max_tokens)
...
# If the user has entered a question and an API key, generate a response
